        ...
        <div class="col-md-9">
            <div class="col-md-12" style="background-color:rgba(80,77,77,0.9);height:100%;color:#FFFFFF">
                <div class="row" style="height:50px">
                    <div class="col-md-3" style="margin-top:10px;text-align:center;font-size:20px">已售订单信息</div>
                    <div class="col-md-5" style="margin-top:10px;text-align:center;font-size:20px"></div>
                    <form class="navbar-form navbar-left" role="search">
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="指定起始日期：yyyy-mm-dd" id="SearchDate">
                        </div>
...
<script type="text/javascript">
    ...
    $("#Search_btn").click(function () {
        ...
        if (searchDate.trim().length == 0) {
            ...
            $.ajax({
                url: "${APP_PATH}/orders" + "/" + searchDate,
                data: "pn=" + 1,
                type: "GET",
                success: function (result) {
                    //1、解析并显示订单数据
