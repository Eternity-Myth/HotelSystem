...
<body style="background-image:url(../pics/UIpic/background.jpg);background-repeat:no-repeat;background-attachment:fixed;background-size: 100%">
        ...
        <div class="col-md-8 col-md-offset-2" style="background-color:rgba(0,0,0,0.8);height:60px">
            <p class="col-md-4"
               style="text-align:center;padding-top:15px;height:60px;color:#FFFFFF;font-size:20px;font-family:'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif">
                <img src="../pics/UIpic/home.png" style="height:25px">&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)"
                                                                                           onclick="location.reload()"
                                                                                           style="color:#ffffff">HOME</a>&nbsp;&nbsp;&nbsp;
            </p>
            <p class="col-md-4"
               style="text-align:center;padding-top:15px;height:60px;color:#FFFFFF;font-size:20px;font-family:'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif">
                <img src="../pics/UIpic/management.png" style="height:25px"><a href="/sign-in.jsp"
                                                                               style="color:#ffffff">&nbsp;&nbsp;&nbsp;MANAGEMENT</a>
            </p>
            <p1 class="col-md-4"
                style="text-align:center;padding-top:15px;height:60px;color:#FFFFFF;font-size:20px;font-family:'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif">
                <img src="../pics/UIpic/sign.png" style="height:25px">&nbsp;&nbsp;&nbsp;<a href="/sign-in.jsp"
                                                                                           style="color:#ffffff">SIGN&nbsp;IN</a>&nbsp;/<a
            ...
            <div id="myCarousel" class="carousel slide" style="margin-top:15px;margin-bottom:15px">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="../pics/UIpic/pic1.jpg" alt="First slide">
                    </div>
                    <div class="item">
                        <img src="../pics/UIpic/pic2.jpg" alt="Second slide">
                    </div>
                    <div class="item">
                        <img src="../pics/UIpic/pic3.jpg" alt="Third slide">
                    </div>
                </div>
                <!-- 轮播（Carousel）导航 -->
    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2" style="background-color:rgba(0,0,0,0.8);height:60px">
            <div class="col-md-4 col-md-offset-4"
                 style="text-align:center;padding-top:15px;height:60px;color:#FFFFFF;font-size:20px;font-family:'Gill Sans', 'Gill Sans MT', 'Myriad Pro', 'DejaVu Sans Condensed', Helvetica, Arial, sans-serif">
                <img src="../pics/UIpic/contact.png" style="height:25px">
