        ...
        <div class="col-md-9">
            <div class="col-md-12" style="background-color:rgba(80,77,77,0.9);height:100%;color:#FFFFFF">
                <div class="row" style="height:50px">
                    <div class="col-md-3" style="margin-top:10px;text-align:center;font-size:20px">所有房型均价信息</div>
                        ...
                        <div class="col-md-12">
                            <table class="table table-hover" id="hotel_table">
                                ...
                                <tr style="color: #ffffff">
                                    ...
                                    <th style="text-align:center">剩余房间数量</th>
...
<script type="text/javascript">
    ...
    function to_page(pn) {
        $.ajax({
            url: "${APP_PATH}/hotels-price-alltype",
            data: "pn=" + pn,
            type: "GET",
    ...
    function build_hotel_table(result) {
        ...
        $.each(price, function (index, item) {
            ...
            var remainTd = $("<td></td>").append(item.remain);
    ...
    $("#Search_btn").click(function () {
        ...
        else if (startDate.trim().length != 0 && leaveDate.trim().length != 0 && require.length != 0) {
            $.ajax({
                url: "${APP_PATH}/hotels-price-alltype" + "/" + startDate + "~" + leaveDate + "*" + require,
                data: "pn=" + 1,
                type: "GET",
                success: function (result) {
                    //1、解析并显示酒店数据
